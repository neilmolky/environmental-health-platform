...
class ClientModel(BaseSettings):
    """The settings defined here can be inherrited to create clients that may be populated from env variables.
    ...
    class MyClient(ClientModel):
        client_from_env: MockClient | LiveClient = Field(default_factory=dict, discriminator="type")
